...
// Rcpp Version of the RRI
// [[Rcpp::export]]
NumericVector RRI_cpp(NumericVector x, size_t ni, size_t nw) {
    NumericVector out(ni);
    assert(nw == 25);

    // direct cpp adaptation of SurfRough::RRI
    // see Trevisani et al. 2023. Hacking the topographic ruggedness index.
    //     Geomorphology, Volume 439, 2023, https://doi.org/10.1016/j.geomorph.2023.108838
